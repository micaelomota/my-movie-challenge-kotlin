...
class MovieListAdapter(private val list: List<MovieListViewModel>, private val movieListView: MovieList.View): RecyclerView.Adapter<MovieListAdapter.MovieViewHolder>() {
